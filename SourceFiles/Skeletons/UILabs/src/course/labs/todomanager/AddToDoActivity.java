	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		cancelButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// (Ex TO DO) - Indicate result and finish
		...
		resetButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				// (Ex TO DO) - Reset data to default values
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// (Ex TO DO) - Get the current Priority
				Priority priority = getPriority();

				// (Ex TO DO) - Get the current Status
				Status status = getStatus();

				// (Ex TO DO) - Get the current ToDoItem Title
				...
				// (EX TO DO) - return data Intent and finish
